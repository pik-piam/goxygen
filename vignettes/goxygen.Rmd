...
Any of the identifiers , except for `@stop`, can be combined with the `extrapage` attribute as follows: `@identifier extrapage="page"`, for example: 
...
The documentation will be moved to a new page as specified (e.g. "settings" in the example above). 
**Important:** The page name can only consist of characters and numbers and the rest of the documentation must follow on a new comment line.
