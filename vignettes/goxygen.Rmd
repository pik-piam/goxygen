...
Goxygen can extract the documentation from plain GAMS code (see next section) or from GAMS models that have a modularized structure as described in http://dx.doi.org/10.5194/gmd-12-1299-2019 (see further down).
